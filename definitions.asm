...
; file:	definitions.asm   target ATmegred28L-4MHz-STK300
...
;registres pour le panneau led

.def	green	= r18	
.def	red	= r19		 
.def	blue	= r20

;registres pour les loops

.def	loop	= r21	
.def	loop2	= r22	
.def	main_loop_count	= r23

;registres pour l'encodeur
...
.equ	GP2_AVAL = 3; Shart GP2Y0_blue1 distance measuring sensor
